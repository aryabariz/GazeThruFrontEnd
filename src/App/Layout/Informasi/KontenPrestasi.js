...
class KontenPrestasi extends Component {
    constructor(props){
        super(props);
    ...
    <body className='Body'>
      ...
      <div class="ZonaKonten">
                  ...
                  <Slider ref={c => (this.slider = c)} {...settings}>
                    ...
                    <div key={Prestasi.id}>
                     <div class="GambarPrestasi centerImage "  > 
                     <img  class="ui fluid image" src={Prestasi.image_agenda} alt="poster"/>
                     </div>
                    <p class="JudulArtikel">{Prestasi.nama_agenda}</p>
                    <p class="FontTextAgenda TextKetArtikel">{Prestasi.nama_agenda}</p>
                    </div>
